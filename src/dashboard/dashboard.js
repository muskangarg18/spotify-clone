...
const playTrack=(event,{image,name,artistNames,duration,previewUrl,id})=>{
    ...
    console.log(image,name,artistNames,duration,previewUrl,id);
...
const loadPlaylistTracks = ({tracks})=>{
   ...
   for (let trackitem of tracks.items.filter(item => item.track.preview_url)){
    ...
    track.id=id;
    track.className="track p-1 grid grid-cols-[50px_1fr_1fr_50px] items-center justify-items-start rounded-md gap-4 text-secondary hover:bg-light-black"
    ...
    track.innerHTML=`
        ...
        playButton.addEventListener("click",(event)=>playTrack(event,{image,name,artistNames,duration,previewUrl,id}))
...
const fillContentForPlaylist = async(playlistId)=>{
    ...
    `
    const pageContent = document.querySelector("#page-content");
    pageContent.innerHTML=`<header class="mx-8 py-4 z-10  border-secondary border-b-[0.5px]" id="playlist-header">
    <nav class="py-2" >
...
{/* <section class="track grid grid-cols-[50px_2fr_1fr_50px] items-center justify-items-start rounded-md gap-4 text-secondary hover:bg-light-black
">
